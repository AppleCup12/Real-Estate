<div class="libary-group">
            <div class="row">
              ...
              <?PHP 
                $query_real = mysqli_query($conn, "SELECT * FROM `Real-document` WHERE `r_radio` IN('$c') AND `real_type` IN ('$b') AND `real_distric` IN ('$a') AND `real_uid`=2 ORDER BY real_id DESC");
                  ...
                  <div class="card-libary">
                    ...
                    <div class="list-about-real">
                      <div class="list-padding">
                        ...
                        <label for=""><div class="about-real-text"><? echo $row_real['real_about_laos'] ?></div></label>
          ...
          &nbsp;
         <div class="group-hr">
          <label id="label-hrt">ລາຍການຄົ້ນຫາສີນສຸດ</label>
          <div class="hrt"></div>
         </div>