...
if($show_top_wa){
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> $show_top_wa, "name"=> "ຍອດກົດໃຈ TOP 1", "color"=> "#ff0000"),
    array("y"=> $show_top_all, "name"=> "ຍອດລວມທັ້ງໝົດ", "color"=> "#546BC1")
  );
}else{
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> 1, "name"=> "ຍອດກົດໃຈ TOP 1", "color"=> "#ff0000"),
    array("y"=> 1, "name"=> "ຍອດລວມທັ້ງໝົດ", "color"=> "#546BC1")
  );
}
if($show_top_all){
  $newVsReturningVisitorsDataPoints = array(
