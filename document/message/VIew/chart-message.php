...
if($show_top_wa){
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> $show_top_em, "name"=> "ຍອດວິວ TOP 1", "color"=> "#0040ff"),
    array("y"=> $show_top_wa, "name"=> "ການສົນທະນາທາງ Email", "color"=> "#cc00cc")
  );
}else{
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> 1, "name"=> "ຍອດວິວ TOP", "color"=> "#0040ff"),
    array("y"=> 1, "name"=> "ຍອດວີວທັ້ງໝົດ", "color"=> "#cc00cc")
  );
}
if($show_top_em){
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> $show_top_em, "name"=> "ຍອດວິວ TOP 1", "color"=> "#0040ff"),
    array("y"=> $show_top_wa, "name"=> "ຍອດວີວທັ້ງໝົດ", "color"=> "#cc00cc")
  );
}else{
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> 1, "name"=> "ຍອດວິວ TOP 1", "color"=> "#0040ff"),
    array("y"=> 1, "name"=> "ຍອດວີວທັ້ງໝົດ", "color"=> "#cc00cc")
  );
}
...
<button class="btn-sm invisible" id="backButton">&lt; ຍ້ອນກັບ</button>
<div class="hidden" style="margin-left: 5px"></div>
