...
if($show_top_wa){
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> $show_top_wa, "name"=> "ການສົນທະນາທາງ WhatsApp", "color"=> "#00cc00"),
    array("y"=> $show_top_em, "name"=> "ການສົນທະນາທາງ Email", "color"=> "#546BC1")
  );
}else{
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> 1, "name"=> "ການສົນທະນາທາງ WhatsApp", "color"=> "#00cc00"),
    array("y"=> 1, "name"=> "ການສົນທະນາທາງ Email", "color"=> "#546BC1")
  );
}
if($show_top_em){
  $newVsReturningVisitorsDataPoints = array(
