...
if($show_top_wa){
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> $show_top_wa, "name"=> "ການບັນທືດລວມ TOP 1", "color"=> "#00b3b3"),
    array("y"=> $show_top_all, "name"=> "ການບັນທືກລວມທັ້ງໝົດ", "color"=> "#9900cc")
  );
}else{
  $newVsReturningVisitorsDataPoints = array(
    array("y"=> 1, "name"=> "ການບັນທືດລວມ TOP 1", "color"=> "#00b3b3"),
    array("y"=> 1, "name"=> "ການບັນທືກລວມທັ້ງໝົດ", "color"=> "#9900cc")
  );
}
if($show_top_all){
  $newVsReturningVisitorsDataPoints = array(
