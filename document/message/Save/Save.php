          ...
          <div class="messae-padding">
            ...
            <div class="group-message">
              <div class="group-header-ms">
                <h5><i class="bi bi-bookmark-heart-fill"></i> ລາຍການຂໍ້ມູນອະສັງຫາຍອດກົດໃຈ</h5>
                <label for="" style="font-size: 12p3;">ລາຍການຂອງລູກຄ້າທີ່ມີຄວາມສົນໃຈ ບັນທືກ ຕໍ່ອະສັງຫາຂອງທ່ານ</label>
              </div>
              <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <a href="" class="btn btn-warning">ຍອດບັນທືກ</a>
              </div>
                &nbsp;
              <div class="card group-about-ms">
                <?PHP 
                  ...
                  $show_wa_top = mysqli_fetch_array(mysqli_query($conn, "SELECT `save_id`,`cound_save`,`user_uid`,`real_uid`, COUNT(*)as count FROM `user_save` WHERE `real_uid` IN($cdk_delete 0) GROUP BY `real_uid` ORDER BY count DESC"));
                  $show_top_wa = $show_wa_top['count'];

                  $show_top = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*)as count FROM `user_save` WHERE `real_uid` GROUP BY `real_uid` IN($cdk_delete 0)"));
                  ...
                  <div class="column column-about">
                    ...
                    <div class="card-about-ms email">
                      <div class="text-ms">
                        ...
                        <label style="font-size: 16px">ການບັນທືກລວມ TOP 1: </label>
                    ...
                    <div class="card-about-ms qty">
                      <div class="text-ms">
                        ...
                        <label style="font-size: 16px">ການບັນທືກລວມທັ້ງໝົດ: </label>
              ...
              <div class="card group-about-ms">
                <div class="group-header"><h4>ຕາລາງຂໍ້ມູນສອບຖາມ</h4></div><hr>
                  <?PHP
                    $show_all = mysqli_query($conn, "SELECT `save_id`,`cound_save`,`user_uid`,`real_uid`, COUNT(*)as count FROM `user_save` WHERE `real_uid` IN($cdk_delete 0) GROUP BY `real_uid` ORDER BY count DESC LIMIT 6");
                    $argc = 1;
