...
if (isset($_POST['home_id'])) {
	$query_v = "SELECT * FROM `AM-dcm-village` where `distric_id`=".$_POST['home_id'];
	...
	if ($result_v->num_rows > 0 ) {
		...
		echo '<option>No Village Found!</option>';
	}

}elseif (isset($_POST['home'])) {
	$query_h = "SELECT * FROM `AM-dcm-home` where dcm_home_id=".$_POST['home'];
